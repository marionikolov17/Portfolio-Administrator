...
export default function DesktopNavigation() {
    ...
    return (
        <>
            <nav className="hidden sm:block w-20 lg:w-[280px] shrink-0 sticky h-screen top-0 z-50 bg-primary-900">
                ...
                <div className="w-full flex flex-col items-center px-2 lg:px-6">
                    ...
                    <NavigationButton to="/certificates" isActive={location.pathname === "/certificates"} title="Certificates" icon="certificates" />
                </div>
            </nav>
        </>
    )
