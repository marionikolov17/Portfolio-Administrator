...
export default function TopBar() {
    return (
        <>
            <header className="w-full bg-primary-900 min-h-9 sticky top-0 flex items-center justify-center sm:justify-end py-2 px-12 overflow-hidden">
                {/* Profile Link */}
                ...
                <button className="flex items-center justify-center h-full text-brand-600 text-xl ms-4 hover:bg-primary-950 p-2 rounded-lg transition duration-300">
                    <IoLogOutOutline />
                </button>
            </header>
        </>
