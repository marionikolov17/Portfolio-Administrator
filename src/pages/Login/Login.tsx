        ...
        >
          ...
          <div className="mt-6 w-full">
            ...
            <div className="flex w-full items-center bg-transparent border border-primary-800 rounded-lg overflow-hidden mt-1 transition duration-300 hover:ring-2 hover:ring-brand-600">
              ...
              {!isShownPassword && (
                <IoMdEye
                  className="mx-3 text-xl cursor-pointer text-white"
          ...
          <button 
            disabled={user.isLoginLoading}
            className="mt-6 w-full py-2 flex justify-center text-sm bg-brand-600 text-white rounded-lg shadow transition duration-300 hover:ring-1 hover:ring-primary-800 disabled:bg-brand-200"
          >
            Sign in
          </button>
          {user.hasLoginError && <p className="text-center mt-2 text-sm text-red-600">Invalid credentials!</p>}
        </form>
      </main>
    </>
  );
